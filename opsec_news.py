...
def process_and_send_article(article_url: str, article_title: str, sent_urls: set, fallback_text: str = "") -> bool:
    ...
    # Global-Standard CTI Prompt: Tactical Technical English
    prompt = f"""
    ### ROLE:
    Act as a Senior Cyber Threat Intelligence (CTI) Specialist. Your goal is to parse raw security data into a structured, high-fidelity technical advisory.
    ...
    ### INSTRUCTIONS:
    1. **Language:** Strict Professional Technical English.
    2. **Analysis:** Extract specific indicators, vulnerabilities (CVEs), and TTPs (Tactics, Techniques, and Procedures).
    3. **Accuracy:** NO HALLUCINATION. If technical depth is missing, focus on the strategic impact.
    4. **Tone:** Objective, authoritative, and tactical.

    ### REQUIRED FORMAT (Use HTML tags for Telegram compatibility):
    <b>🛡️ Tactical Intelligence Report</b>

    <b>🎯 Executive Summary:</b>
    (A high-level overview of the threat and its global significance. Max 2 sentences.)

    <b>🔍 Technical Analysis & Impact:</b>
    • <b>Vector:</b> (e.g., RCE, Phishing, Supply Chain)
    • <b>Affected:</b> (Affected systems/versions or CVE IDs)
    • <b>Key Findings:</b> (3 bullet points of deep technical details)

    <b>🛠️ Remediation & Strategy:</b>
    (Provide actionable, step-by-step technical recommendations to mitigate the risk.)

    ---
    <i>Generated by <b>Sentinel-OSINT-Pipeline</b> | Tactical Grade Intel</i>
    """
    ...
    try:
        ...
        final_text = f"🚨 <b>{article_title}</b>\n\n{analysis}\n\n<a href='{article_url}'>🔗 قراءة المصدر</a>"
